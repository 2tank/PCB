<%@ page import="com.example.pcb.entidades.Categoria" %>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ page import="java.util.List" %>
<%@ page import="com.example.pcb.entidades.AtributoUsuario" %>
<%@ page import="java.util.Objects" %>

<%
    List<AtributoUsuario> atributos = (List<AtributoUsuario>) request.getAttribute("atributos");
%>
...
<div class="title">
    ...
    <ul class="category-list">
        ...
        <%for (AtributoUsuario att: atributos) {%>
        <li>
            <div>
